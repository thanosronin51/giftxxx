    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('Europe', 'Europe'), ('United States', 'United States')], max_length=50)),
                ('description', models.TextField(blank=True)),
                ('about', models.TextField(blank=True)),
                ('job_date', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('contract', models.CharField(choices=[('Part Time', 'Part Time'), ('Full Time', 'Full Time'), ('Freelance', 'Freelance'), ('Remote', 'Remote')], max_length=150)),
