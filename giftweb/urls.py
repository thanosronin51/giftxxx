...
urlpatterns = [
    ...
    path('make_payment/product/<int:product_id>/', make_payment_for_product, name='make_payment_product'),
    path('make_payment/premium_product/<int:premium_product_id>/', make_payment_for_premium_product, name='make_payment_premium_product'),
]
